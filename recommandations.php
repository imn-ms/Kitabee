...
.emotion-select {
    ...
    background:#fff url('data:image/svg+xml;utf8,<svg fill="black" height="20" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg"><path d="M7 10l5 5 5-5z"/></svg>') no-repeat right .7rem center;
    background-size: 14px;
    padding:.55rem 2.3rem .55rem .75rem;
    border:1px solid #ddd;
    border-radius:10px;
    font-size:.9rem;
    min-width:190px;
...
.emotion-select:focus {
    outline:2px solid rgba(95,127,95,.35);
    outline-offset:2px;
}
.link-more {
